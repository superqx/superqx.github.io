...
const siteUrl = "https://superqx.github.io"; 
let updatedUrl = currentUrl.replace("https://superqx.github.io", "");
...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "导航菜单",
          handler: () => {
            window.location.href = "/_pages/zh-CN/dropdown/";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "",handler: () => {
              window.location.href = "/books/zh-CN/the_godfather/";
          ...
          description: "",
          section: "新闻",handler: () => {
              window.location.href = "/news/zh-CN/announcement_2/";
          ...
          section: "课题",handler: () => {
              window.location.href = "/projects/zh-CN/1_project/";
            },},{id: "projects-projeto-2",
          title: 'projeto 2',
          description: "um projeto com imagem de fundo e comentários do giscus",
          section: "课题",handler: () => {
              window.location.href = "/projects/zh-CN/2_project/";
            },},{id: "projects-projeto-3-com-um-nome-bem-longo",
          title: 'projeto 3 com um nome bem longo',
          description: "um projeto que redireciona pra outro website",
          section: "课题",handler: () => {
              window.location.href = "/projects/zh-CN/3_project/";
            },},{id: "projects-projeto-4",
          title: 'projeto 4',
          description: "outro sem imagem",
          section: "课题",handler: () => {
              window.location.href = "/projects/zh-CN/4_project/";
            },},{id: "projects-projeto-5",
          title: 'projeto 5',
          description: "um projeto com imagem de fundo",
          section: "课题",handler: () => {
              window.location.href = "/projects/zh-CN/5_project/";
            },},{id: "projects-projeto-6",
          title: 'projeto 6',
          description: "um projeto sem imagem",
          section: "课题",handler: () => {
              window.location.href = "/projects/zh-CN/6_project/";
            },},{
        id: 'social-email',
